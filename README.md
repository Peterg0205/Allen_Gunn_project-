...
<br>--engine = create_engine(f'postgresql://postgres:{password}@localhost:5433/obes_pov2017_db')
...
<br>>print(database_exists(engine.url))<br>
4.	Next connect the CSVs that were created above to Pandas to be read <br>
<br>--csv_ob = pd.read_csv('./Obesity Overweight and Weight Control Final Clean.csv')
<br>--csv_cen= pd.read_csv('./School_Poverty_data2017.csv')<br>
5.	The last step is to convert the Pandas dataframes to SQL tables in Postgres.<br>
...
<br>
6.	Open Postgres to ensure database was created. <br>
